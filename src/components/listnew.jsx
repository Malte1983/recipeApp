    ...
    return (
        <div className='container mx-auto p-4'>
            {!selectedRecipe ? (
                <>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                        {filteredRecipes.map((recipe) => (
                            <div key={recipe.id} className="bg-white rounded-lg shadow-md p-4 cursor-pointer" onClick={() => handleSelectRecipe(recipe)}>
                ...
                <RecipeEditor recipe={selectedRecipe} onSave={handleSaveEdit} onCancel={handleCancelEdit} />
            ) : (
                <RecipeDetails
